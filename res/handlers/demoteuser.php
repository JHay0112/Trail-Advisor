<?php
    ...
    /*
        ...
        Description:
            ...
            Demotes a staff user to standard user.
    ...
    */
    ...
    // Prepare statment
    $stmt = mysqli_prepare($link, "UPDATE users SET user_type = 'Standard' WHERE user_id = ?");
    ...
    print("<script>location = '../../profile.php?user_id=".$user_id."&referral_case=userdemoted'</script>");
